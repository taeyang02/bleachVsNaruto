...
//			_ui.comb_mode.addItem( { label: "SINGLE VS", data:2 } );
    ...
    private function btnHandler():void {
        ...
        if (LANGameCtrl.I.isOnline) {
            _creating = true;
            LANServerCtrl.I.onOnlineRoomCreated = onOnlineCreated;
            LANServerCtrl.I.onOnlineRoomFailed  = onOnlineFailed;
    ...
    private function onOnlineCreated(roomCode:String):void {
        _creating = false;
        LANServerCtrl.I.onOnlineRoomCreated = null;
        LANServerCtrl.I.onOnlineRoomFailed  = null;

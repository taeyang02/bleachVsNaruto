...
//		public static const SERVER_WAIT_CLIENT:int = 30;
    ...
    public static function updateParams():void {
        ...
        var baseLock:int = _LOCK_KEYFRAME;
        // Online: larger input delay buffer for higher ping
        if (LANGameCtrl.I.isOnline) {
            OnlineConfig.load();
            baseLock = OnlineConfig.lockKeyframe > 0 ? OnlineConfig.lockKeyframe : 6;
        }
        LOCK_KEYFRAME = baseLock * rate;
